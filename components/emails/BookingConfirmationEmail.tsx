          ...
          <Container className='w-[600px] max-w-[100%] border-[1px] border-solid border-[#432f1f]'>
            ...
            <Section className='p-12 text-center'>
              ...
              <Text style={{ ...global.text, marginTop: 24 }}>
                To ensure a smooth experience, please arrive on time with a
                clean, moisturized face. If you need to reschedule or have any
                questions, feel free to reach out at info@shashafaces.com or
                (678) 925-2550. We can’t wait to see you and enhance your
                natural beauty!
              </Text>
            </Section>
            <Hr style={global.hr} />
            <Section className='p-8 bg-[#f2eae3]'>
              <div className='flex justify-around'>
                <div className='flex justify-center items-center'>
                  <Img
                    src={`${baseUrl}/images/email-icon.png`}
                    alt='Makeup Icon'
